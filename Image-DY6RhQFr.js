...
function liftColor(color2) {
  if (isString(color2)) {
    ...
    ret.colorStops = map(color2.colorStops, function(stop) {
      return {
        offset: stop.offset,
...
export {
  ...
  guid as a6,
  lum as a7,
  DARK_MODE_THRESHOLD as a8,
  isTypedArray as a9,
  cubicSubdivide as aA,
  normalize as aB,
  cubicDerivativeAt as aC,
  quadraticDerivativeAt as aD,
  quadraticAt as aE,
  Point as aF,
  Transformable as aG,
  hasOwn as aH,
  concatArray as aI,
  disableUserSelect as aJ,
  devicePixelRatio as aK,
  isGradientObject as aL,
  isImagePatternObject as aM,
  logError as aN,
  SHAPE_CHANGED_BIT as aO,
  createOrUpdateImage as aP,
  DEFAULT_COMMON_STYLE as aQ,
  RADIAN_TO_DEGREE as aR,
  ...
  adjustTextY as ao,
  Displayable as ap,
  DEFAULT_COMMON_ANIMATION_PROPS as aq,
  DEFAULT_FONT_SIZE as ar,
