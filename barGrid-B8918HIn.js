import { z as env, _ as __extends, p as indexOf, B as BoundingRect, ae as Element, u as isString, x as reduce, g as map, ad as eqNaN, s as isFunction, af as isRegExp, N as assert, t as isObject, F as isNumber, ag as isStringSafe, r as isArray, M as createHashMap, e as each$1, q as inherits, o as extend, ah as getLineHeight, U as retrieve2, ai as getWidth, T as retrieve3, aj as findExistImage, ak as isImageReady, L as parsePercent$1, H as Path, Q as keys, al as DEFAULT_FONT, am as TSpan, an as adjustTextX, ao as adjustTextY, Z as ZRImage, a0 as trim, ap as Displayable, n as defaults, aq as DEFAULT_COMMON_ANIMATION_PROPS, ar as DEFAULT_FONT_SIZE, as as normalizeCssArray$1, at as liftColor, O as isArrayLike, P as PathProxy, c as applyTransform$1, a as min, b as max, au as clone, av as sub, aw as scale, ax as distance, ay as add, az as quadraticSubdivide, aA as cubicSubdivide, aB as normalize, aC as cubicDerivativeAt, I as cubicAt, aD as quadraticDerivativeAt, aE as quadraticAt, aF as Point, i as identity, d as mul, aG as Transformable, f as invert, aH as hasOwn, v as merge, k as clone$1, m as mixin, l as curry, a9 as isTypedArray, j as bind, aI as concatArray, K as calculateTextPosition } from "./Image-DY6RhQFr.js";
var LN2 = Math.log(2);
...
function handleGlobalMouseOverForHighDown(dispatcher, e2, api) {
  ...
  if (dispatchers) {
    ...
    each$1(dispatchers, function(dispatcher2) {
...
function setTooltipConfig(opt) {
  ...
  if (formatterParamsExtra) {
    each$1(keys(formatterParamsExtra), function(key) {
...
var CoordinateSystemManager = (
  ...
  function() {
    ...
    CoordinateSystemManager2.prototype.create = function(ecModel, api) {
      ...
      each$1(coordinateSystemCreators, function(creator, type) {
...
export {
  ...
  formatTime as a7,
  formatTpl as a8,
  getTooltipMarker as a9,
  SPECIAL_STATES as aA,
  createRenderPlanner as aB,
  inheritDefaultOption as aC,
  warn as aD,
  removeElementWithFadeOut as aE,
  setLabelValueAnimation as aF,
  createProgressiveLayout as aG,
  layout as aH,
  VISUAL_DIMENSIONS as aI,
  isSourceInstance as aJ,
  DefaultDataProvider as aK,
  DataStore as aL,
  SOURCE_FORMAT_TYPED_ARRAY as aM,
  isDataItemOption as aN,
  convertOptionIdName as aO,
  setCommonECData as aP,
  isSeriesDataSchema as aQ,
  SOURCE_FORMAT_ORIGINAL as aR,
  createSourceFromSeriesDataOption as aS,
  shouldOmitUnusedDimensions as aT,
  ensureSourceDimNameMap as aU,
  createDimNameMap as aV,
  CtorInt32Array as aW,
  normalizeToArray as aX,
  guessOrdinal as aY,
  BE_ORDINAL as aZ,
  SeriesDataSchema as a_,
  normalizeCssArray as aa,
  toCamelCase as ab,
  truncateText as ac,
  ChartView as ad,
  ComponentModel as ae,
  SeriesModel as af,
  registerLocale as ag,
  throttle as ah,
  retrieveRawValue as ai,
  enterEmphasis as aj,
  leaveEmphasis as ak,
  saveOldStyle as al,
  getLabelStatesModels as am,
  normalizeSymbolOffset as an,
  setLabelStyle as ao,
  toggleHoverEmphasis as ap,
  removeElement as aq,
  normalizeSymbolSize as ar,
  traverseElements as as,
  createFloat32Array as at,
  convertToColorString as au,
  setStatesStylesFromModel as av,
  queryDataIndex as aw,
  setStatesFlag as ax,
  interpolateRawValues as ay,
  labelInner as az,
  enableHoverEmphasis as b,
  leaveBlur as b$,
  makeSeriesEncodeForAxisCoordSys as b0,
  CoordinateSystemManager as b1,
  getDataItemValue as b2,
  OrientedBoundingRect as b3,
  fetchLayoutMode as b4,
  getLayoutParams as b5,
  mergeLayoutParam as b6,
  setTooltipConfig as b7,
  subPixelOptimizeLine as b8,
  makeInner as b9,
  TEXT_STYLE_OPTIONS as bA,
  addSafe as bB,
  getUID as bC,
  enableClassExtend as bD,
  enableClassManagement as bE,
  makeStyleMapper as bF,
  LINE_STYLE_KEY_MAP as bG,
  ITEM_STYLE_KEY_MAP as bH,
  createTask as bI,
  parseClassType as bJ,
  getLeastCommonMultiple as bK,
  registerExternalTransform as bL,
  getAttribute as bM,
  setAttribute as bN,
  createLocaleObject as bO,
  SYSTEM_LANG as bP,
  parseFinder as bQ,
  isSelectChangePayload as bR,
  isHighDownPayload as bS,
  allLeaveBlur as bT,
  getAllSelectedIndices as bU,
  updateSeriesElementSelection as bV,
  isElementRemoved as bW,
  HOVER_STATE_EMPHASIS as bX,
  HOVER_STATE_BLUR as bY,
  savePathStates as bZ,
  enterBlur as b_,
  groupTransition as ba,
  graphic as bb,
  createOrUpdate as bc,
  clear as bd,
  applyTransform as be,
  transformLocalCoord as bf,
  getPaddingFromTooltipModel as bg,
  throwError as bh,
  getTooltipRenderMode as bi,
  createTooltipMarkup as bj,
  TooltipMarkupStyleCreator as bk,
  normalizeTooltipFormatResult as bl,
  buildTooltipMarkup as bm,
  parsePercent as bn,
  preParseFinder as bo,
  queryReferringComponents as bp,
  isCanvasEl as bq,
  transformCoordWithViewport as br,
  isComponentIdInternal as bs,
  resetSourceDefaulter as bt,
  mappingToExists as bu,
  setComponentTypeToKeyInfo as bv,
  error as bw,
  PaletteMixin as bx,
  deprecateLog as by,
  deprecateReplaceLog as bz,
  createTextStyle as c,
  enterSelect as c0,
  leaveSelect as c1,
  HIGHLIGHT_ACTION_TYPE as c2,
  blurSeriesFromHighlightPayload as c3,
  findComponentHighDownDispatchers as c4,
  blurComponent as c5,
  toggleSelectionFromPayload as c6,
  isHighDownDispatcher as c7,
  handleGlobalMouseOverForHighDown as c8,
  handleGlobalMouseOutForHighDown as c9,
  dateGetterName as cA,
  monthGetterName as cB,
  fullYearGetterName as cC,
  fullYearSetterName as cD,
  prepareLayoutBarSeries as cE,
  makeColumnLayout as cF,
  retrieveColumnLayout as cG,
  DOWNPLAY_ACTION_TYPE as ca,
  SELECT_ACTION_TYPE as cb,
  UNSELECT_ACTION_TYPE as cc,
  TOGGLE_SELECT_ACTION_TYPE as cd,
  fullLeveledFormatter as ce,
  getDefaultFormatPrecisionOfInterval as cf,
  getPrimaryTimeUnit as cg,
  leveledFormat as ch,
  ONE_DAY as ci,
  ONE_SECOND as cj,
  ONE_MINUTE as ck,
  ...
  ONE_YEAR as cm,
  timeUnits as cn,
  isPrimaryTimeUnit as co,
  secondsSetterName as cp,
  millisecondsSetterName as cq,
  minutesSetterName as cr,
  hoursSetterName as cs,
  dateSetterName as ct,
  monthSetterName as cu,
  getUnitValue as cv,
  millisecondsGetterName as cw,
  secondsGetterName as cx,
  minutesGetterName as cy,
  hoursGetterName as cz,
  getECData as d,
  enableDataStack as e,
  getLayoutRect as f,
  getStackedDimension as g,
  MAX_SAFE_INTEGER as h,
  isDimensionStacked as i,
  asc as j,
  getPercentWithPrecision as k,
  getPixelPrecision as l,
  getPrecision as m,
  getPrecisionSafe as n,
  isNumeric as o,
  isRadianAroundZero as p,
  linearMap as q,
  nice as r,
  numericToNumber as s,
  parseDate as t,
  quantile as u,
  quantity as v,
  quantityExponent as w,
  reformIntervals as x,
  remRadian as y,
  round$1 as z
};
