...
export {
  ...
  toCamelCase as a9,
  registerPostInit as aA,
  registerPostUpdate as aB,
  registerPreprocessor as aC,
  registerProcessor as aD,
  registerTheme as aE,
  registerTransform as aF,
  registerUpdateLifecycle as aG,
  registerVisual as aH,
  setCanvasCreator as aI,
  throttle as aJ,
  version as aK,
  ...
  disconnect as am,
  dispose as an,
  getCoordinateSystemDimensions as ao,
  getInstanceByDom as ap,
  getInstanceById as aq,
  getMap as ar,
  init as as,
  parseGeoJSON as at,
  registerAction as au,
  registerCoordinateSystem as av,
  registerLayout as aw,
  registerLoading as ax,
  registerLocale as ay,
  registerMap as az,
  createSymbol as b,
